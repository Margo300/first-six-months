...
const COPY: Record<number, Record<Band, { heading: string; body: string }>> = {
  ...
  2: {
    "finding-it-hard": {
      ...
      body: "Your responses point to a real wobble in how confident you are feeling — in conversations, in how you come across, in what you bring. That kind of shakiness is exhausting to carry, and it can make everything feel harder than it needs to be. It is worth asking whether this is new, or whether it has followed you into this role. Either way, it deserves attention.",
    },
    "in-the-middle": {
    ...
    "largely-settled": {
      ...
      body: "You seem reasonably settled in how you come across and what you offer. There is a groundedness in your responses here that suggests you have a workable sense of who you are in this role. That does not mean there are no hard moments — but you appear to have access to your own confidence when you need it.",
    },
  },
  3: {
    "finding-it-hard": {
    ...
    "in-the-middle": {
      ...
      body: "There are areas where you have a clear enough sense of direction, and others where things feel less settled. That is a reasonable description of most leaders in the first six months. The challenge is not to have a perfect plan — it is to have enough of a compass to make decisions without constantly second-guessing them. It sounds like you are partway there.",
    },
    "largely-settled": {
      heading: "You have a clear enough compass",
      body: "You seem to have a reasonable grip on what matters, where you are headed, and how to manage your own agenda. That clarity is genuinely useful at this stage — it makes it easier to say no, to stay steady when priorities shift, and to avoid being pulled in too many directions at once.",
    },
  },
  4: {
    "finding-it-hard": {
      heading: "Relationships and influence feel like work",
      body: "Your responses suggest that the relational side of this role feels effortful or incomplete right now — whether that is building new connections, navigating upwards, or managing the shift with people who knew you before. Relationships are often the last thing to settle in a new role, and the pressure to get them right quickly can make them feel harder. It is worth thinking about where even small investments might make a difference.",
    },
    "in-the-middle": {
    ...
    "largely-settled": {
      ...
      body: "You seem to have made good progress on the relational side of this role — building what you need, finding ways to influence effectively, and navigating some of the trickier dynamics that come with a transition. That does not happen by accident. It is worth recognising what you have put into that.",
    },
  },
};
